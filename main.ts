controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    asteroids = sprites.createProjectileFromSprite(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Projectile, function (sprite, otherSprite) {
    sprites.destroy(asteroids, effects.smiles, 500)
    asteroids.startEffect(effects.smiles)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    sprites.destroy(mySprite, effects.halo, 100)
...
game.onUpdateInterval(1000, function () {
    asteroids = sprites.createProjectileFromSide(img`
        ...
        . . . . . . b 6 6 c c . . . . . 
        `, 0, 50)
    asteroids.x = randint(0, scene.screenWidth())
